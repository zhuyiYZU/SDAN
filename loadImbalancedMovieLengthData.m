...
function [Train_CM, Train_FM, All_FM,Q] = loadImbalancedMovieLengthData(itemNum,userNum)
 
    % 将所有训练数据存储为满矩阵
     % Train_FM中，m个user，n个item，M是n*m 
     filename = 'C:\Users\Lenovo\Documents\MATLAB\SDAN\data\ml-100k\imbalabced\user';
    ...
    % 将所有数据中，用户商品矩阵存储为满矩阵
     filename = 'C:\Users\Lenovo\Documents\MATLAB\SDAN\data\ml-100k\imbalabced\user.data';
